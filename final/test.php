<?php              
  ...
  switch($today) {
    ...
    case 'Tuesday':
        ...
        $pic = 'dune.jpg';
        $alt = 'Dune Movie';
        $content = 'Dune takes you into a future where interstellar travel and complex political machinations reign. At the heart is the desert planet of Arrakis, the only source of the invaluable spice Melange.';
        break;
    case 'Wednesday':
        $movie = '<h2>Wednesday is Everything Everywhere All At Once Day</h2>';
        $pic = 'everywhere.jpg';
        $alt = 'Everything Everywhere All At Once Movie';
        $content = 'Everything Everywhere All At Once is an intriguing science fiction drama that plays with the multiverse theory. It explores personal and cosmic issues through its complex but relatable characters.';
        break;
    case 'Thursday':
        $movie = '<h2>Thursday is Guardians of the Galaxy Day</h2>';
        $pic = 'guardians.jpg';
        $alt = 'Guardians of the Galaxy Movie';
        $content = 'Guardians of the Galaxy mixes humor with action, following a group of intergalactic misfits who band together to protect a powerful orb. The film is both a visual spectacle and a story of friendship.';
        break;
    case 'Friday':
        $movie = '<h2>Friday is Riddick Day</h2>';
        $pic = 'riddick.jpg';
        $alt = 'Riddick Movie';
        $content = 'Riddick offers a gritty take on the survival genre, starring Vin Diesel as the antihero stranded on a hostile planet. The movie balances action and suspense, making it a fitting choice for a Friday.';
        break;
    case 'Saturday':
        $movie = '<h2>Saturday is Star Wars Day</h2>';
        $pic = 'starwars.jpg';
        $alt = 'Star Wars Movie';
        $content = 'Star Wars is more than just a movie; it\'s a cultural phenomenon that has captured the hearts of generations. The epic saga of good versus evil in a galaxy far, far away makes for compelling viewing.';
        break;
    case 'Sunday':
        $movie = '<h2>Sunday is Star Trek Day</h2>';
        $pic = 'startrek.jpg';
        $alt = 'Star Trek Movie';
        $content = 'Star Trek focuses on the voyages of the starship USS Enterprise. More than just a space adventure, the series also tackles ethical and social issues, making it a thought-provoking watch for a Sunday.';
        break;
  }
?>
<div id="wrapper">
